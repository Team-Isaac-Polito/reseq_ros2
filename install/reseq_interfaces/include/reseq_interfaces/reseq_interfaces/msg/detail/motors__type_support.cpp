...
{
  new (message_memory) reseq_interfaces::msg::Motors(_init);
}

void Motors_fini_function(void * message_memory)
{
  auto typed_message = static_cast<reseq_interfaces::msg::Motors *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Motors_message_member_array[2] = {
  {
    ...
    offsetof(reseq_interfaces::msg::Motors, left),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(reseq_interfaces::msg::Motors, right),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Motors_message_members = {
  ...
  "Motors",  // message name
  2,  // number of fields
  sizeof(reseq_interfaces::msg::Motors),
...
get_message_type_support_handle<reseq_interfaces::msg::Motors>()
{
  return &::reseq_interfaces::msg::rosidl_typesupport_introspection_cpp::Motors_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, reseq_interfaces, msg, Motors)() {
  return &::reseq_interfaces::msg::rosidl_typesupport_introspection_cpp::Motors_message_type_support_handle;
}
