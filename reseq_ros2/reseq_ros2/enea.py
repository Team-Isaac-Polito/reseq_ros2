...
class Enea(Node):
    ...
    def consume_velocities(self, msg: EndEffector):
        try:
            ...
            self.get_logger().error(f'Error in consume_velocities: {str(e)}\n{traceback.format_exc()}')
    ...
    def post(self):
        ...
        try:
            ...
            self.get_logger().error(f'Error in post: {str(e)}\n{traceback.format_exc()}')
    ...
    def constrain(self):
        ...
        try:
            ...
            self.get_logger().error(f'Error in constrain: {str(e)}\n{traceback.format_exc()}')
    ...
    def constrain_delta_pitch(self, dp):
        ...
        try:
            ...
            self.get_logger().error(f'Error in constrain_delta_pitch: {str(e)}\n{traceback.format_exc()}')
            raise
