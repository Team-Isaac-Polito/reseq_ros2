...
states = (
    ...
    ReseQState(
        'end_effector/head_pitch/feedback', ['arm_head_pitch'], StateType.END_EFFECTOR_FEEDBACK
    ),
    ReseQState(
        'end_effector/head_roll/feedback', ['arm_head_roll'], StateType.END_EFFECTOR_FEEDBACK
    ),
)
