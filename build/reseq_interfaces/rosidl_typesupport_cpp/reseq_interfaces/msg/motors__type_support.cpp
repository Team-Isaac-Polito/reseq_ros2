...
static const _Motors_type_support_symbol_names_t _Motors_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, reseq_interfaces, msg, Motors)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, reseq_interfaces, msg, Motors)),
  }
};
...
{
  return &::reseq_interfaces::msg::rosidl_typesupport_cpp::Motors_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, reseq_interfaces, msg, Motors)() {
  return get_message_type_support_handle<reseq_interfaces::msg::Motors>();
}
