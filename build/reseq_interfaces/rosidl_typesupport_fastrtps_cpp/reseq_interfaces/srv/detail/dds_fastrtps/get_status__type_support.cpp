...
#include "reseq_interfaces/srv/detail/get_status__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const reseq_interfaces::srv::GetStatus_Request & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  reseq_interfaces::srv::GetStatus_Request & ros_message)
{
  // Member: structure_needs_at_least_one_member
  cdr >> ros_message.structure_needs_at_least_one_member;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = reseq_interfaces::srv::GetStatus_Request;
    is_plain =
      (
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_reseq_interfaces
max_serialized_size_key_GetStatus_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
{
  auto typed_message =
    static_cast<const reseq_interfaces::srv::GetStatus_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<reseq_interfaces::srv::GetStatus_Request *>(
    untyped_ros_message);
...
{
  return &reseq_interfaces::srv::typesupport_fastrtps_cpp::_GetStatus_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, reseq_interfaces, srv, GetStatus_Request)() {
  return &reseq_interfaces::srv::typesupport_fastrtps_cpp::_GetStatus_Request__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_reseq_interfaces
cdr_serialize(
  const reseq_interfaces::srv::GetStatus_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: current_mode
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  reseq_interfaces::srv::GetStatus_Response & ros_message)
{
  // Member: current_mode
  cdr >> ros_message.current_mode;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = reseq_interfaces::srv::GetStatus_Response;
    is_plain =
      (
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_reseq_interfaces
max_serialized_size_key_GetStatus_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
{
  auto typed_message =
    static_cast<const reseq_interfaces::srv::GetStatus_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<reseq_interfaces::srv::GetStatus_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &reseq_interfaces::srv::typesupport_fastrtps_cpp::_GetStatus_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, reseq_interfaces, srv, GetStatus_Response)() {
  return &reseq_interfaces::srv::typesupport_fastrtps_cpp::_GetStatus_Response__handle;
}
...
// functions for reseq_interfaces::srv::GetStatus_Request already declared above

// functions for reseq_interfaces::srv::GetStatus_Response already declared above
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_reseq_interfaces
cdr_serialize(
  const reseq_interfaces::srv::GetStatus_Event & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: info
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  reseq_interfaces::srv::GetStatus_Event & ros_message)
{
  // Member: info
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_reseq_interfaces
max_serialized_size_GetStatus_Event(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // Member: request
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        reseq_interfaces::srv::typesupport_fastrtps_cpp::max_serialized_size_GetStatus_Request(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // Member: response
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        reseq_interfaces::srv::typesupport_fastrtps_cpp::max_serialized_size_GetStatus_Response(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = reseq_interfaces::srv::GetStatus_Event;
    is_plain =
      (
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_reseq_interfaces
max_serialized_size_key_GetStatus_Event(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // Member: request
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        reseq_interfaces::srv::typesupport_fastrtps_cpp::max_serialized_size_key_GetStatus_Request(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // Member: response
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        reseq_interfaces::srv::typesupport_fastrtps_cpp::max_serialized_size_key_GetStatus_Response(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
...
{
  auto typed_message =
    static_cast<const reseq_interfaces::srv::GetStatus_Event *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<reseq_interfaces::srv::GetStatus_Event *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _GetStatus_Event__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const reseq_interfaces::srv::GetStatus_Event *>(
...
static size_t _GetStatus_Event__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_GetStatus_Event(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _GetStatus_Event__callbacks = {
  "reseq_interfaces::srv",
  "GetStatus_Event",
...
static rosidl_message_type_support_t _GetStatus_Event__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_GetStatus_Event__callbacks,
  get_message_typesupport_handle_function,
...
{
  return &reseq_interfaces::srv::typesupport_fastrtps_cpp::_GetStatus_Event__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, reseq_interfaces, srv, GetStatus_Event)() {
  return &reseq_interfaces::srv::typesupport_fastrtps_cpp::_GetStatus_Event__handle;
}
...
static const rosidl_service_type_support_t _GetStatus__handle{
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_GetStatus__callbacks,
  get_service_typesupport_handle_function,
  ::rosidl_typesupport_fastrtps_cpp::get_message_type_support_handle<reseq_interfaces::srv::GetStatus_Request>(),
  ::rosidl_typesupport_fastrtps_cpp::get_message_type_support_handle<reseq_interfaces::srv::GetStatus_Response>(),
  ::rosidl_typesupport_fastrtps_cpp::get_message_type_support_handle<reseq_interfaces::srv::GetStatus_Event>(),
...
{
  return &reseq_interfaces::srv::typesupport_fastrtps_cpp::_GetStatus__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, reseq_interfaces, srv, GetStatus)() {
  return &reseq_interfaces::srv::typesupport_fastrtps_cpp::_GetStatus__handle;
}
