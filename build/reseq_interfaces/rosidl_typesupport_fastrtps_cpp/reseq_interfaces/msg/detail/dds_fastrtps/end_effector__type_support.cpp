...
#include "reseq_interfaces/msg/detail/end_effector__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const reseq_interfaces::msg::EndEffector & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  reseq_interfaces::msg::EndEffector & ros_message)
{
  // Member: pitch_vel
  cdr >> ros_message.pitch_vel;
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_reseq_interfaces
max_serialized_size_EndEffector(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = reseq_interfaces::msg::EndEffector;
    is_plain =
      (
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_reseq_interfaces
max_serialized_size_key_EndEffector(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
{
  auto typed_message =
    static_cast<const reseq_interfaces::msg::EndEffector *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<reseq_interfaces::msg::EndEffector *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _EndEffector__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const reseq_interfaces::msg::EndEffector *>(
...
static size_t _EndEffector__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_EndEffector(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _EndEffector__callbacks = {
...
static rosidl_message_type_support_t _EndEffector__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_EndEffector__callbacks,
...
{
  return &reseq_interfaces::msg::typesupport_fastrtps_cpp::_EndEffector__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, reseq_interfaces, msg, EndEffector)() {
  return &reseq_interfaces::msg::typesupport_fastrtps_cpp::_EndEffector__handle;
}
