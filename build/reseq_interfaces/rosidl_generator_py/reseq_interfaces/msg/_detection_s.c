...
bool reseq_interfaces__msg__detection__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("reseq_interfaces.msg._detection.Detection", full_classname_dest, 41) == 0);
  }
  reseq_interfaces__msg__Detection * ros_message = _ros_message;
  {  // header
  ...
  {  // detection
    ...
    ros_message->detection = (int32_t)PyLong_AsLong(field);
    Py_DECREF(field);
  }
  {  // type
  ...
  {  // depth_center
    PyObject * field = PyObject_GetAttrString(_pymsg, "depth_center");
    if (!field) {
      return false;
    }
    assert(PyFloat_Check(field));
    ros_message->depth_center = (float)PyFloat_AS_DOUBLE(field);
    Py_DECREF(field);
  }
  {  // camera_frame
...
PyObject * reseq_interfaces__msg__detection__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("reseq_interfaces.msg._detection");
  ...
  {  // detection
    PyObject * field = NULL;
    field = PyLong_FromLong(ros_message->detection);
    {
  ...
  {  // depth_center
    PyObject * field = NULL;
    field = PyFloat_FromDouble(ros_message->depth_center);
    {
      int rc = PyObject_SetAttrString(_pymessage, "depth_center", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
